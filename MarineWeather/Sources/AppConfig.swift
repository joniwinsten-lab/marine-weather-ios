...
enum AppConfig {
    ...
    static let marketingVersion = "0.3.9"

    /// Match Android `WEATHER_USER_AGENT`; bump version when shipping.
    static let weatherUserAgent = "MarineWeather/0.3.9 (fi.veneappi.MarineWeather; planning app)"
    ...
    static let digitrafficUser = "MarineWeather/0.3.9 (fi.veneappi.MarineWeather)"
